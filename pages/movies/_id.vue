...
export default {
  ...
  methods: {
    async getDetail() {
      try {
        const { data } = await this.$api.movies.getDetail(this.$route.params.id);
    ...
    async getReview() {
      try {
        const { data } = await this.$api.movies.getReview(this.$route.params.id);
    ...
    async getRecommend() {
      try {
        const { data } = await this.$api.movies.getRecommendation(this.$route.params.id);
